...
@swagger_auto_schema(
    ...
    manual_parameters=[ 
        ...
        openapi.Parameter("department_id", openapi.IN_FORM, description="ID du département", type=openapi.TYPE_INTEGER, required=False),
    ...
    try:
        ...
        if department_id:
            try:
                ...
                return Response({"error": f"Département avec l'ID '{department_id}' introuvable."}, status=400)
